...
class TipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tip" do
    assert_difference('Tip.count') do
      post tips_url, params: { tip: { game_id: @tip.game_id, hour: @tip.hour, tipAwayTeam: @tip.tipAwayTeam, tipHomeTeam: @tip.tipHomeTeam } }
    end
  ...
  test "should update tip" do
    patch tip_url(@tip), params: { tip: { game_id: @tip.game_id, hour: @tip.hour, tipAwayTeam: @tip.tipAwayTeam, tipHomeTeam: @tip.tipHomeTeam } }
